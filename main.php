...
<html lang="en">
    ...
    <body class="cm-no-transition cm-1-navbar">
                ...
                <div class="dropdown pull-right">
                    ...
                    <ul class="dropdown-menu">
                        <li class="disabled text-center">
                            <a style="cursor:default;"><strong>NOMBRE_USUARIO</strong></a>
                        </li>
                        <li class="divider"></li>
                        <li>
        ...
        <div id="global">
            ...
            <footer class="cm-footer"><span class="pull-left">Conectado como: NOMBRE_USUARIO</span><span class="pull-right">&copy; PAOMEDIA SARL</span><span class="pull-right">&copy; JIP -</span></footer>
        </div>
