...
<?php
  ...
  $_SESSION['actual'] = 'lista_adq';

  $conexion = db_conn();
  $sql = "SELECT * FROM solicitud_adquisicion";
...
<html lang="en">
    <head>
        ...
        <title>GPI - Ver Solicitud de Adquisición</title>
    </head>
    <body class="cm-no-transition cm-1-navbar">
        ...
        <header id="cm-header">
            <nav class="cm-navbar cm-navbar-primary">
                ...
                <div class="cm-flex">
                    <h1>Ver Solicitud de Adquisición</h1>
                </div>
             ...
             <?php
                if ($resultado->num_rows > 0){
                  ...
                  while ($row = $resultado->fetch_assoc()){
                    echo "
                    <tr>
                        <td><a href='detalle_adquisicion.php?id=" . $row["sol_id"] . "'> " . $row["sol_id"] . "</a></td>
                        <td>" . $row["emisor"] . "</td>
